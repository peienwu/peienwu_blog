...
通式：$k_n\cdot(100^{1/n})=100,k_n=\frac{100}{(100^{1/n})}$
...
以開二次方根來計算，則考36分的人可以恰好及格。假設考$b$分的人經過調整後為$a$分（及格的話$a = 60$），所開的次方數為$n$次，則有以下關係：

$$n = g(a,b)= \frac{2-\log b}{2-\log a}$$

則對於分數為$x$的人，調整後的分數$f(x)$滿足：
...
由第一點的公式，我們可以觀察到，要將越低的分數調整到及格，所開的次方數$n$就必須越大，圖形如下圖：
